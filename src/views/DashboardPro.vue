<template>
  <div class="g-sidenav-show bg-gray-100 g-sidenav-hidden">
    ...
    >
      ...
      <div class="ps__rail-y" style="top: 0px; height: 772px; right: 0px">
        <div
          class="ps__thumb-y"
          tabindex="0"
          style="top: 0px; height: 661px"
        ></div>
      </div>
    </aside> -->
                    ...
                    >
                      <div class="d-flex py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                          <h6
                            class="text-sm font-weight-normal mb-1 text-white"
                          >
    ...
    <div class="fixed-plugin ps">
      ...
      <div class="card shadow-lg">
        ...
        <div class="card-body pt-sm-3 pt-0 overflow-auto">
          ...
          <div class="d-flex">
            <button
              class="btn bg-gradient-primary w-100 px-3 mb-2 active me-2 disabled"
              data-class="bg-white"
            ...
            <button
              class="btn bg-gradient-primary w-100 px-3 mb-2 disabled"
...
const fetchTheatere = async () => {
  try {
    const { data } = await axios.get(`${BASE_API_URL}/theaters`);
    theaterList.value = data; // Update the ref value
  } catch (error) {
    console.error("Error fetching===>", error);
  }
};
const fetchBooking = async () => {
  try {
    ...
    bookingList.value = data; // Update the ref value
  } catch (error) {
    console.error("Error fetching===>", error);
  }
};
